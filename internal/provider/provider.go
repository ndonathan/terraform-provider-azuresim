...
func (p *AzureSimProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewManagedDiskResource,
		NewUserAssignedIdentityResource,
		NewKeyVaultResource,
		NewLogAnalyticsWorkspaceResource,
		NewStorageContainerResource,
		NewSubnetNSGAssociationResource,
		NewNetworkSecurityRuleResource,
		NewKeyVaultSecretResource,
		NewKeyVaultKeyResource,
		NewRoleAssignmentResource,
		NewApplicationInsightsResource,
		NewServicePlanResource,
		NewWindowsVirtualMachineResource,
		NewRouteTableResource,
		NewSubnetRouteTableAssociationResource,
		NewPrivateDNSZoneResource,
		NewPrivateDNSZoneVNetLinkResource,
		NewVirtualNetworkPeeringResource,
		NewLinuxWebAppResource,
		NewWindowsWebAppResource,
		NewLinuxFunctionAppResource,
		NewWindowsFunctionAppResource,
		NewMSSQLServerResource,
		NewMSSQLDatabaseResource,
		NewContainerRegistryResource,
		NewKubernetesClusterResource,
		NewCosmosDBAccountResource,
		NewRedisCacheResource,
		NewServiceBusNamespaceResource,
		NewEventHubNamespaceResource,
		NewLoadBalancerResource,
		NewRecoveryServicesVaultResource,
		NewServiceBusQueueResource,
		NewServiceBusTopicResource,
		NewServiceBusSubscriptionResource,
		NewEventHubResource,
		NewStorageBlobResource,
		NewNATGatewayResource,
		NewApplicationGatewayResource,
		NewFirewallResource,
		NewPostgreSQLFlexibleServerResource,
		NewMySQLFlexibleServerResource,
		NewContainerAppEnvironmentResource,
		NewContainerAppResource,
		NewLinuxVMSSResource,
		NewWindowsVMSSResource,
		NewPrivateEndpointResource,
		NewMonitorDiagnosticSettingResource,
		NewMonitorActionGroupResource,
		NewMonitorMetricAlertResource,
		NewBastionHostResource,
		NewAPIManagementResource,
		NewFrontDoorProfileResource,
	}
}
